...
images = {datetime.strptime(os.path.basename(file)[:-4], '%Y-%m-%d_%H:%M'): cv2.cvtColor(cv2.imread(file), cv2.COLOR_BGR2RGB) for file in glob.glob(IMAGE_PATH + '/*.jpg')}
